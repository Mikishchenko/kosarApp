...
//   }
   ...
   static func generatePartnersData() -> [userID:Partner] {
    ...
    let bel = Backendless.sharedInstance()!
    
    let partners = Array(sampleDict.values)
    
    //Synchronous save of multiple objects
    print(bel.data.of(Partner.self).createBulk(partners))
